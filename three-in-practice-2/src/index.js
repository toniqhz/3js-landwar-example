import { 
  ...
  Vector2, TextureLoader, SphereGeometry, MeshStandardMaterial, MeshBasicMaterial
...
// let sphereMess = new Mesh(
//   new SphereGeometry(5,10,10),
//   new MeshBasicMaterial({color: 0xff0000})
// );
// scene.add(sphereMess);
...
(async function() {
  let envmapTexture = await new RGBELoader().loadAsync("assets/landwar.hdr");
...
function tileToPosition(tileX, tileY) {
  return new Vector2((tileX + (tileY % 5) * 0.5) * 1.5, tileY * 1.5);
}
